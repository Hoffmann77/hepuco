...
from .const import (
    DOMAIN, CONF_PV_POWER, CONF_GRID_EXPORT, CONF_POWER_HP,
    CONF_TRESHOLD_0, CONF_TRESHOLD_10, CONF_TRESHOLD_20,
)


_LOGGER = logging.getLogger(__name__)

DEFAULT_TITLE = "Hepuco - Heat pump coordinator"
...
class ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def get_shema_user_step(self, user_input: dict) -> vol.Schema:
        ...
        schema = {
            ...
            vol.Required(CONF_GRID_EXPORT): selector.EntitySelector(
                selector.EntitySelectorConfig()
            ),
        }
    ...
    def get_shema_config_step(self) -> vol.Schema:
        """Return the schema for the user step."""
        schema = {
            vol.Required(CONF_POWER_HP): int,
            vol.Required(CONF_TRESHOLD_0): int,
            vol.Required(CONF_TRESHOLD_10): int,
            vol.Required(CONF_TRESHOLD_20): int,
        }
        return vol.Schema(schema)
